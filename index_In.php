                ...
                <div class = "navbar-content">
                    <div class = "brand-and-toggler">
                        <a href = "index.php" class = "navbar-brand">
                            ...
                            <span class = "navbar-brand-text">CV Generate System</span>
                        </a>
                        <div>
						<a href = "My_CV.php" class = "btn btn-secondary text-uppercase">My Profile</a>
                        <a href = "Update_CV.php" class = "btn btn-secondary text-uppercase">Create My CV</a>
						<a id="log_option" href="Login_dbo.php?logout='1'" class = "btn btn-secondary text-uppercase">
					<?php if(isset($_SESSION['username'])) echo $_SESSION['username']." "?> Logout
				</a>
        ...
        <header class = "header bg-bright" id = "header">
            <div class = "container">
                <div class = "header-content text-center">
                    ...
                    <!-- <a href = "CV.html" class = "btn btn-primary text-uppercase">create my CV</a> -->
                    <a href = "Update_CV.php" class = "btn btn-primary text-uppercase">create my CV</a>
                    <a href = "templates.php" class = "btn btn-secondary text-uppercase">View All Templates</a>
            ...
            <div class="container">
                <div class = "section-one-content">
                    ...
                    <div class = "section-one-r text-center">
                        ...
                        <div class = "btn-group">
                            <a href = "CV.html" class = "btn btn-primary text-uppercase">create my CV</a>
                            <a href = "https://youtu.be/peiPQzRIxpI" class = "btn btn-secondary text-uppercase">watch video</a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="section-two-content">
                    <div class = "section-items">
                        <div class = "section-item">
                            ...
                            <h5 class = "section-item-title">Enhanced Visibility!</h5>
                        ...
                        <div class = "section-item">
                            ...
                            <h5 class = "section-item-title">Tailored to Your Strengths!</h5>
                        ...
                        <div class = "section-item">
                            ...
                            <h5 class = "section-item-title">Increased Confidence</h5>
